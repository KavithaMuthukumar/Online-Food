...
<body>
	...
	<div class="container my-3">
		<div class="d-flex py-3">
			<h3>合計: ¥${(total>0)?dcf.format(total):0}</h3>
			<a class="mx-3 btn btn-primary" href="cart-check-out">チェックアウト</a>
		</div>
				...
				<tr>
					...
					<td>
						<form action="order-now" method="post" class="form-inline">
							...
							<button type="submit" class="btn btn-primary btn-sm">今すぐ注文</button>
						</form>
					</td>
